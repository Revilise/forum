...
const IconWrapper = ({children, cssClass, isActive}) => {
    return (
        <div className={ isActive ? cl[cssClass + "__active"] : cl[cssClass] }>
            {children}
        </div>
    )
}
...
export const { Home, ChevronDown, ChevronUp, LogIn, LogOut, PlusCircle, Search, User, Settings, Save, Image, Link, Trash, Send, Edit } = Icons;